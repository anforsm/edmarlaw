...
const References = () => {
  ...
  return (
    <div className={"flex flex-col relative items-center px-4"}>
      ...
      {/* <div>test</div> */}
      <Slider
        className="w-full !flex !items-center !flex-wrap py-10 pt-16 slider-class"
        {...settings}
      >
        {/* <div>
            <p>{t("quote1")}</p>
...
function CarouselSlide({ body, author, position }) {
  return (
    <div className="flex flex-col justify-end h-full gap-y-11 w-full p-2 px-10 items-center">
      <div className="filler"></div>
      <div
        className={
          "flex flex-col gap-y-2 bg-white w-full rounded-[50px] shadow-lg p-14 relative slide-class"
          // "relative"
        }
      >
      ...
      <div className="flex flex-col items-center gap-y-2 title-class">
...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className={`!flex !relative !left-0 !basis-1/12 pb-24 left-arrow-class`}
      onClick={onClick}
    >
      <svg
        width="60"
...
function SampleNextArrow(props) {
  ...
  return (
    <div
      className={`!flex !relative !right-0 !basis-1/12 pb-24 !justify-end right-arrow-class`}
      onClick={onClick}
    >
      <svg
        width="60"
