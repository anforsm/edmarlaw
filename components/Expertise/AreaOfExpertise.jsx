  ...
  const areasOfExpertise = [
    {
      title: "AI",
      image: "/techlogo.png",
      svg: <svg width="16" height="16" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5.5 1.25V2.5H7.25V1.25C7.25 0.84375 7.5625 0.5 8 0.5C8.40625 0.5 8.75 0.84375 8.75 1.25V2.5H10.5V1.25C10.5 0.84375 10.8125 0.5 11.25 0.5C11.6562 0.5 12 0.84375 12 1.25V2.5C13.0938 2.5 14 3.40625 14 4.5H15.25C15.6562 4.5 16 4.84375 16 5.25C16 5.6875 15.6562 6 15.25 6H14V7.75H15.25C15.6562 7.75 16 8.09375 16 8.5C16 8.9375 15.6562 9.25 15.25 9.25H14V11H15.25C15.6562 11 16 11.3438 16 11.75C16 12.1875 15.6562 12.5 15.25 12.5H14C14 13.625 13.0938 14.5 12 14.5V15.75C12 16.1875 11.6562 16.5 11.25 16.5C10.8125 16.5 10.5 16.1875 10.5 15.75V14.5H8.75V15.75C8.75 16.1875 8.40625 16.5 8 16.5C7.5625 16.5 7.25 16.1875 7.25 15.75V14.5H5.5V15.75C5.5 16.1875 5.15625 16.5 4.75 16.5C4.3125 16.5 4 16.1875 4 15.75V14.5C2.875 14.5 2 13.625 2 12.5H0.75C0.3125 12.5 0 12.1875 0 11.75C0 11.3438 0.3125 11 0.75 11H2V9.25H0.75C0.3125 9.25 0 8.9375 0 8.5C0 8.09375 0.3125 7.75 0.75 7.75H2V6H0.75C0.3125 6 0 5.6875 0 5.25C0 4.84375 0.3125 4.5 0.75 4.5H2C2 3.40625 2.875 2.5 4 2.5V1.25C4 0.84375 4.3125 0.5 4.75 0.5C5.15625 0.5 5.5 0.84375 5.5 1.25ZM6.5 6C6.28125 6 6.09375 6.125 6.03125 6.3125L4.71875 9.3125L4.28125 10.3125C4.15625 10.5625 4.28125 10.8438 4.53125 10.9688C4.78125 11.0938 5.09375 10.9688 5.1875 10.7188L5.5 10H7.46875L7.78125 10.7188C7.90625 10.9688 8.1875 11.0938 8.4375 10.9688C8.6875 10.875 8.8125 10.5625 8.6875 10.3125L8.25 9.3125L6.9375 6.3125C6.875 6.125 6.6875 6 6.5 6ZM7.03125 9H5.9375L6.5 7.75L7.03125 9ZM10.5 6C10.2188 6 10 6.25 10 6.5V10.5C10 10.7812 10.2188 11 10.5 11C10.75 11 11 10.7812 11 10.5V6.5C11 6.25 10.75 6 10.5 6Z" fill="#00ADEE" />
      </svg>,
    ...
    },
    {
      ...
      svg: <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9 1C6.46875 1 4.1875 2.34375 2.9375 4.5C1.65625 6.6875 1.65625 9.34375 2.9375 11.5C4.1875 13.6875 6.46875 15 9 15C11.5 15 13.7812 13.6875 15.0312 11.5C16.3125 9.34375 16.3125 6.6875 15.0312 4.5C13.7812 2.34375 11.5 1 9 1ZM9 16C6.125 16 3.5 14.5 2.0625 12C0.625 9.53125 0.625 6.5 2.0625 4C3.5 1.53125 6.125 0 9 0C11.8438 0 14.4688 1.53125 15.9062 4C17.3438 6.5 17.3438 9.53125 15.9062 12C14.4688 14.5 11.8438 16 9 16ZM11.0938 10.125C11.3125 9.9375 11.625 9.9375 11.8125 10.125C12 10.3438 12 10.6562 11.8125 10.8438C10.25 12.4062 7.71875 12.4062 6.15625 10.8438C4.59375 9.28125 4.59375 6.75 6.15625 5.1875C7.71875 3.625 10.25 3.625 11.8125 5.1875C12 5.375 12 5.6875 11.8125 5.90625C11.625 6.09375 11.3125 6.09375 11.0938 5.90625C9.9375 4.71875 8.03125 4.71875 6.875 5.90625C5.6875 7.0625 5.6875 8.96875 6.875 10.125C8.03125 11.3125 9.9375 11.3125 11.0938 10.125Z" fill="#00ADEE" />
      </svg>
      ,
